...
export default function Home() {
  ...
  const [currentPage, setCurrentPage] = useRecoilState(NavAtom)
  useGSAP(() => {
  ...
  return (
    <>
      ...
      <LuBrain style={{fontSize:'72px',position:'absolute', display:'none'}} />
      ...
      <HiMiniCpuChip style={{fontSize:'72px', position:'absolute', display:'none'}} />
      ...
      <section className="center contact">
          ...
          <div>TRY IT</div> <TfiArrowTopRight style={{marginLeft: '10px', marginTop:'10px'}} />
          </div>
      </section>
